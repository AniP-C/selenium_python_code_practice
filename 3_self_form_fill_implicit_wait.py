...
"""
So implicitly_wait function waiting for maximum 3.5 seconds, it waits till the element is present
in the DOM ,that also only for maximum of 3.5 seconds if it is presen in DOM in less than 3.5
secs time it carry forwards with the next one
...
send_email.send_keys("nikhahah@gmail.com")
...
upload_loc.send_keys("C:/Users/Aniruddh Parashar/Desktop/PESA/padhai/cow.png")
